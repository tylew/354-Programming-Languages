...
----------
main = do
    print $ addP (T(T(T(T(T(I)))))) (T I) -- T (T (T (T (T (T (T I))))))
    print $ multP (T(T(T(T(T(I)))))) (T I) -- T (T (T (T (T (T (T (T (T (T (T I))))))))))
    print $ nn_pp (T(T(T(T(I))))) -- S (S (S (S (S O))))
    print $ ii_pp (T(T(T(T(I))))) -- II (S (S (S (S (S O))))) O
    ...
    print $ (S(S(S(S((S O)))))) >= (S(S O)) -- True
    print $ addI (II (S(S(S(S O)))) (S O)) (II (S(S(S(S O)))) (S O)) -- II (S (S (S (S (S (S (S (S O)))))))) (S (S O))
    print $ multI (II (S(S(S(S O)))) (S O)) (II (S(S(S(S O)))) (S O)) -- II (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S O))))))))))))))))) (S (S (S (S (S (S (S (S O))))))))
    ...
    print $ normalizeI (II (nn_int 7) (nn_int 4)) -- II (S (S (S O))) O
    print $ nn_int 6 -- S (S (S (S (S (S O)))))
    print $ int_nn (S(S(S(S O)))) -- 4
    print $ ii_int 12 -- II (S (S (S (S (S (S (S (S (S (S (S (S O)))))))))))) O
    print $ int_ii (II(S(S(S(S O)))) (S O)) -- 3
    print $ pp_int 6 -- T (T (T (T (T I))))
    print $ int_pp (T(T(T(T(T(T I)))))) -- 7
    print $ float_qq (QQ (II (S(S O)) O) (T(T I))) -- 0.6666667
